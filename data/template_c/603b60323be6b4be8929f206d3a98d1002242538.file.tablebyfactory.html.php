<?php /* Smarty version Smarty-3.1.16, created on 2016-05-13 15:23:21
         compiled from "tpl/admin/tablebyfactory.html" */ ?>
<?php /*%%SmartyHeaderCode:17227206305734b5227aab49-94728864%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '603b60323be6b4be8929f206d3a98d1002242538' => 
    array (
      0 => 'tpl/admin/tablebyfactory.html',
      1 => 1463121643,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '17227206305734b5227aab49-94728864',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.16',
  'unifunc' => 'content_5734b52283e1e8_69978313',
  'variables' => 
  array (
    'data' => 0,
    'value' => 0,
...
<?php if ($_valid && !is_callable('content_5734b52283e1e8_69978313')) {function content_5734b52283e1e8_69978313($_smarty_tpl) {?><!doctype html>
<html>
<head>
	<meta charset="utf-8"/>
	<title>后台管理系统</title>
...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="index.php">订单管理中心</a> <div class="breadcrumb_divider"></div> <a class="current">各工厂现有订单统计表</a></article>
		</div>
...
'"/>
								...
								<div class="submitchose2">
									<input class="choosetable2" type="submit" value="各工厂现有订单统计"/>
								</div>
									<input type="submit" name="submit" id="download" value="下载文件" class="alt_btn" onclick="window.location.href='index.php?controller=table&method=downloadTableByFactory&tableid=<?php echo $_GET['tableid'];?>
'"/>
							</div>
